...
ActiveRecord::Schema[7.0].define(version: 2023_05_29_205756) do
  ...
  create_table "products", force: :cascade do |t|
    ...
    t.integer "temperaturerange_id", null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["code"], name: "index_products_on_code", unique: true
    t.index ["productsubgroup_id"], name: "index_products_on_productsubgroup_id"
    t.index ["temperaturerange_id"], name: "index_products_on_temperaturerange_id"
  end
  ...
  add_foreign_key "products", "temperatureranges"
end
